...
export default function Navbar() {
  return (
    /* FIXED: Changed container behavior to a sticky layout floating above content items */
    <header className="sticky top-0 z-50 w-full flex items-center justify-between py-4 px-1 bg-[#03060c]/60 backdrop-blur-md border-b border-gray-900/40 transition-all duration-300">
      ...
      {/* Anchor Tag Document Downloader */}
      <div>
        <a 
